            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html"><img src="{{URL::asset('publica/images/logo.png')}}" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                     ...
                     <li> <a href="#"><img src="{{URL::asset('publica/icon/icon_b.png')}}" alt="#" /></a></li>
                     </ul>
                   </nav>
                 </div>
               </div> 
                ...
                <button class="Search_btn">Search</button>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="images_box">
                      <figure><img src="{{URL::asset('publica/images/img2.png')}}"></figure>
                    </div>
                  </div>
                </div>
              </div>
